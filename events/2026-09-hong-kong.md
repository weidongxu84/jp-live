...
### 1. 佐藤純一 (Junichi Sato) / nonoc — Music World Line in Hong Kong
- **artist:** Junichi Sato (佐藤純一; fhána) and nonoc
- **artist_type:** singer (anisong singer / composer-producer duo)
- **event_title:** 佐藤純一・nonoc 的音樂世界線 in 香港
- **date:** 2026-09-03 (Thu)
...
- **city:** Hong Kong
- **ticket_info:** HK$680 / HK$480. Ticket sales were handled by organizer NEON LIT.
- **source:** https://www.art-mate.net/doc/98610 (listing / organizer information)
- **status:** confirmed
- **notes:** One-night anisong collaboration between fhána composer and keyboardist
  Junichi Sato and singer nonoc. The program included songs connected to *Miss
  Kobayashi's Dragon Maid*, *Re:ZERO*, and *Spy Classroom*.

### 2. KOTOKO — LIVE TOUR 2026 "The Bible 2" in Hong Kong
- **artist:** KOTOKO
- **artist_type:** singer (anisong)
- **event_title:** KOTOKO LIVE TOUR 2026 "The Bible 2" in Hong Kong
- **date:** 2026-09-04 (Fri)
- **time:** Doors 19:00 / start 20:00 (HKT)
- **venue:** PORTAL (1/F & 2/F, The Burrow), 212 Choi Hung Road, San Po Kong, Kowloon
- **city:** Hong Kong
- **ticket_info:** VIP HK$980 (priority entry, 1:1 photo, signed poster) / GA HK$680.
  On sale from 2026-07-03 12:00 HKT via POPTICKET.
- **source:**
...
### 3. 工藤晴香 (Haruka Kudo) — Hong Kong Fan Meeting 2026
- **artist:** Haruka Kudo (工藤晴香)
- **artist_type:** voice_actor (声優 / singer)
- **event_title:** 工藤晴香粉絲見面會香港站2026
- **date:** 2026-09-05 (Sat)
- **time:** Start 13:00 (HKT); doors TBA
- **venue:** Ballroom, 2/F, The Langham Hong Kong, 8 Peking Road, Tsim Sha Tsui,
  Kowloon
- **city:** Hong Kong
- **ticket_info:** HK$880 / HK$480, plus HK$12 UUTIX fee. Reserved electronic
  tickets; currently sold out.
- **source:** https://www.uutix.com/detail?pId=3811 (ticketing)
- **status:** sold_out
...
- **city:** Hong Kong
- **ticket_info:** VIP HK$980 (limited to 150) / GA HK$680, all standing, via KKTIX.
  Dynamic-QR tickets are issued in the KKTIX app.
- **source:**
...
- **date:** 2026-09-12 (Sat)
- **time:** Matinee doors 13:30 / start 14:00; Evening doors 17:30 / start 18:00 (HKT)
- **venue:** Regala Ballroom II, Regala Skycity Hotel, 8 Airport Expo Boulevard,
  Chek Lap Kok
- **city:** Hong Kong
- **ticket_info:** S HK$880 / regular HK$480, all reserved seating; taxes and
  handling fees excluded. On sale via art-mate; maximum 4 tickets per transaction.
- **source:**
...
- **date:** 2026-09-13 (Sun)
- **time:** Doors 17:00 / start 17:30 (HKT)
- **venue:** PORTAL, 1/F, The Burrow, 212 Choi Hung Road, San Po Kong, Kowloon
- **city:** Hong Kong
- **ticket_info:** SVIP HK$1,280 (personalized signed item handover, commemorative
  photo, send-off, priority entry) / VIP HK$980 (signed item handover,
...
- **date:** 2026-09-26 (Sat), 2026-09-27 (Sun)
- **time:** Doors 16:30 / start 18:00 (HKT)
- **venue:** Hall 10, AsiaWorld-Expo, Chek Lap Kok
- **city:** Hong Kong
- **ticket_info:** HK$1,280 (Zone A) / HK$1,080 (Zone B) / HK$880 (Zone C) + HK$40
  handling fee per ticket. Public sale from 2026-05-21 12:00 HKT via Klook.
- **source:**
...
- **venue:** MOM Livehouse, Unit B39, 7 Seas Shopping Centre, 117-121 King's Road,
  North Point, Hong Kong Island
- **city:** Hong Kong
- **ticket_info:** VVIP HK$880 (post-show 1:1 photo + VIP perks) / VIP HK$680
  (priority entry, VIP pass, sign session) / GA HK$480. Via Ticketflap / Neon Lit.
  Max 6 per transaction. Age 12+ (height limit for standing zone).
- **source:**
...
- **ticket_info:** VVIP HK$1,588 (Hi-Bye session + mesh tote bag) / VIP HK$1,488
  ...
  per ticket. Public sale began 2026-08-20 10:00 HKT via Cityline. All seated;
  ages 3+.
- **source:**
...
Japanese acts with Hong Kong 2026 shows **outside September**, or **cancelled**:

| Artist | Type | HK date | Why excluded |
|--------|------|---------|--------------|
| Fujii Kaze (藤井風) | singer | 2026 (Prema Tour) | **HK leg cancelled** (announced Apr 2026) |
| Vaundy | singer | 2026-10-03 | October (see 2026-10 file) |
| Atarayo (あたらよ) | band | 2026-10-19/20/22 | October (see 2026-10 file) |
